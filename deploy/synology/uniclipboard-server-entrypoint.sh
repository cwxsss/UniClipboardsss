...
UC_ADMIN_COOKIE_SECURE="$(strip_outer_quotes "${UC_ADMIN_COOKIE_SECURE:-0}")"
UC_ADMIN_OUTPUT_MAX_BYTES="$(strip_outer_quotes "${UC_ADMIN_OUTPUT_MAX_BYTES:-65536}")"
...
start_admin_web() {
  ...
  UC_ADMIN_COOKIE_SECURE="${UC_ADMIN_COOKIE_SECURE}" \
  UC_ADMIN_OUTPUT_MAX_BYTES="${UC_ADMIN_OUTPUT_MAX_BYTES}" \
  UC_MOBILE_PUBLIC_URL="${UC_MOBILE_PUBLIC_URL}" \
