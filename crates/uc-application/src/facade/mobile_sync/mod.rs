...
pub use facade::{
    ...
    IsDeviceCredentialCurrentError, LanInterfaceOption, ListLanInterfacesError,
    ListMobileDevicesError, MobileDevicePasswordEdit, MobileDeviceSummary, MobileSyncFacade,
