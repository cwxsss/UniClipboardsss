...
Assert-Contains -Path $adminServer -Pattern "buildHarmonyJoinUri"
Assert-Contains -Path $adminServer -Pattern "harmonyJoinUri"
Assert-Contains -Path $adminServer -Pattern "INVITATION_CODE="
Assert-Contains -Path $adminServer -Pattern "CUSTOM_DESKTOP_CODE_UNSUPPORTED"
Assert-Contains -Path $adminServer -Pattern "--device-name"
...
Assert-Contains -Path $adminApp -Pattern "desktopDeviceName"
Assert-Contains -Path $adminApp -Pattern "desktopCustomCode"
Assert-Contains -Path $adminApp -Pattern "desktopPassphrase"
Assert-Contains -Path $adminApp -Pattern "harmonyInviteQr"
Assert-Contains -Path $adminApp -Pattern "harmonyJoinUri"
Assert-Contains -Path $adminIndex -Pattern "desktopInvitePanel"
Assert-Contains -Path $adminIndex -Pattern "desktopInviteForm"
Assert-Contains -Path $adminIndex -Pattern "harmonyInviteQr"
