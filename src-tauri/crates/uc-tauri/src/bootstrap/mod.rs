...
pub use uc_bootstrap::assembly::{
    build_setup_facade, get_storage_paths, resolve_pairing_config, resolve_pairing_device_name,
    wire_dependencies, wire_dependencies_with_identity_store, WiredDependencies,
};
