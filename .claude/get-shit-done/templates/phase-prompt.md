...
<!-- For checkpoint task examples and patterns, see @/Volumes/ExternalSSD/myprojects/uniclipboard-desktop/.claude/get-shit-done/references/checkpoints.md -->
...
See `/Volumes/ExternalSSD/myprojects/uniclipboard-desktop/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/Volumes/ExternalSSD/myprojects/uniclipboard-desktop/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/Volumes/ExternalSSD/myprojects/uniclipboard-desktop/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
