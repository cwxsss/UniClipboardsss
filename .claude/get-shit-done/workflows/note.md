...
- **Global scope**: `/Volumes/ExternalSSD/myprojects/uniclipboard-desktop/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Volumes/ExternalSSD/myprojects/uniclipboard-desktop/.claude/notes/`)
...
2. Glob `/Volumes/ExternalSSD/myprojects/uniclipboard-desktop/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Volumes/ExternalSSD/myprojects/uniclipboard-desktop/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Volumes/ExternalSSD/myprojects/uniclipboard-desktop/.claude/notes/` — works in any directory
