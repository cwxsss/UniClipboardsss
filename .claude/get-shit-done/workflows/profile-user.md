...
- @/Volumes/ExternalSSD/myprojects/uniclipboard-desktop/.claude/get-shit-done/references/ui-brand.md (display patterns)
- @/Volumes/ExternalSSD/myprojects/uniclipboard-desktop/.claude/get-shit-done/agents/gsd-user-profiler.md (profiler agent definition)
- @/Volumes/ExternalSSD/myprojects/uniclipboard-desktop/.claude/get-shit-done/references/user-profiling.md (profiling reference doc)
  </required_reading>
...
```bash
PROFILE_PATH="/Volumes/ExternalSSD/myprojects/uniclipboard-desktop/.claude/get-shit-done/USER-PROFILE.md"
...
```bash
cp "/Volumes/ExternalSSD/myprojects/uniclipboard-desktop/.claude/get-shit-done/USER-PROFILE.md" "/Volumes/ExternalSSD/myprojects/uniclipboard-desktop/.claude/get-shit-done/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /Volumes/ExternalSSD/myprojects/uniclipboard-desktop/.claude/get-shit-done/USER-PROFILE.md
...
```bash
SCAN_RESULT=$(node /Volumes/ExternalSSD/myprojects/uniclipboard-desktop/.claude/get-shit-done/bin/gsd-tools.cjs scan-sessions --json 2>/dev/null)
```
...
```bash
SAMPLE_RESULT=$(node /Volumes/ExternalSSD/myprojects/uniclipboard-desktop/.claude/get-shit-done/bin/gsd-tools.cjs profile-sample --json 2>/dev/null)
```
...
- The user-profiling reference doc at `/Volumes/ExternalSSD/myprojects/uniclipboard-desktop/.claude/get-shit-done/references/user-profiling.md`
...
Reference: @/Volumes/ExternalSSD/myprojects/uniclipboard-desktop/.claude/get-shit-done/references/user-profiling.md
...
```bash
QUESTIONS=$(node /Volumes/ExternalSSD/myprojects/uniclipboard-desktop/.claude/get-shit-done/bin/gsd-tools.cjs profile-questionnaire --json 2>/dev/null)
```
...
```bash
ANALYSIS_RESULT=$(node /Volumes/ExternalSSD/myprojects/uniclipboard-desktop/.claude/get-shit-done/bin/gsd-tools.cjs profile-questionnaire --answers "$ANSWERS_PATH" --json 2>/dev/null)
```
...
```bash
node /Volumes/ExternalSSD/myprojects/uniclipboard-desktop/.claude/get-shit-done/bin/gsd-tools.cjs write-profile --input "$ANALYSIS_PATH" --json 2>/dev/null
```

Display: "✓ Profile written to /Volumes/ExternalSSD/myprojects/uniclipboard-desktop/.claude/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to /Volumes/ExternalSSD/myprojects/uniclipboard-desktop/.claude/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /Volumes/ExternalSSD/myprojects/uniclipboard-desktop/.claude/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
```bash
node /Volumes/ExternalSSD/myprojects/uniclipboard-desktop/.claude/get-shit-done/bin/gsd-tools.cjs generate-dev-preferences --analysis "$ANALYSIS_PATH" --json 2>/dev/null
```

Display: "✓ Generated /gsd:dev-preferences at /Volumes/ExternalSSD/myprojects/uniclipboard-desktop/.claude/commands/gsd/dev-preferences.md"

**For CLAUDE.md profile section (if selected):**

```bash
node /Volumes/ExternalSSD/myprojects/uniclipboard-desktop/.claude/get-shit-done/bin/gsd-tools.cjs generate-claude-profile --analysis "$ANALYSIS_PATH" --json 2>/dev/null
```
...
```bash
node /Volumes/ExternalSSD/myprojects/uniclipboard-desktop/.claude/get-shit-done/bin/gsd-tools.cjs generate-claude-profile --analysis "$ANALYSIS_PATH" --global --json 2>/dev/null
```

Display: "✓ Added profile section to /Volumes/ExternalSSD/myprojects/uniclipboard-desktop/.claude/CLAUDE.md"
...
```bash
BACKUP_PATH="/Volumes/ExternalSSD/myprojects/uniclipboard-desktop/.claude/get-shit-done/USER-PROFILE.backup.md"
```
...
Your profile:    /Volumes/ExternalSSD/myprojects/uniclipboard-desktop/.claude/get-shit-done/USER-PROFILE.md
```
...
```
Artifacts:
  ✓ /gsd:dev-preferences   /Volumes/ExternalSSD/myprojects/uniclipboard-desktop/.claude/commands/gsd/dev-preferences.md
  ✓ CLAUDE.md section       ./CLAUDE.md
  ✓ Global CLAUDE.md        /Volumes/ExternalSSD/myprojects/uniclipboard-desktop/.claude/CLAUDE.md
```
