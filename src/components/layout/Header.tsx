          ...
          {filterTypes.map(filter => {
            ...
            return (
              <m.button
                ...
                className={cn(
                  'relative group flex items-center gap-2 px-3.5 py-2 rounded-lg text-ui-body font-medium whitespace-nowrap transition-all duration-300 outline-none select-none',
                  isActive
