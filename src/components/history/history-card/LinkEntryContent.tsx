...
function LinkEntryContent({ item }: LinkEntryContentProps) {
  ...
  return (
    <div className="space-y-0.5">
      <div className="text-ui-body font-medium text-foreground/85 line-clamp-2">{title}</div>
      <div className="flex items-center gap-1 text-ui-caption text-muted-foreground/70">
